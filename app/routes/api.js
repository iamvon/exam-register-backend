...
let APIRoutes = function (passport) {
    ...
    router.post('/student/exam_schedule/:exam_id', passport.authenticate('jwt', { session: false }), allowOnly(config.accessLevels.user, AdminController.student.getAllStudentSchedule))
