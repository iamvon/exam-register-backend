...
StudentSubjectController.createNewStudentSubject = function (req, res) {
    db.sync().then(function () {
        ...
        StudentSubject.findOne({ where: { student_id: newStudentSubject.student_id, subject_id: newStudentSubject.subject_id, exam_schedule_id: newStudentSubject.exam_schedule_id } }).then(function (data) {
            if (data) {
                res.status(403).json({
                    success: false,
                    data: {},
